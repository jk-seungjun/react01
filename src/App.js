...
function App() {
  ...
  const onLogout =() => {
    sessionStorage.clear()
      setIsLogin(false);
      setLoginInfo('');
      //navigate('/');  ==> navlink 사용안하고 span사용시
  ...
  return (
    <div className="App">
      <Header isLogin={isLogin} onRequestPage={onRequestPage} onLogout={onLogout}
              userName={loginInfo.userName} userId={loginInfo.id}/>
